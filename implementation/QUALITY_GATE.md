...
Phase 1.1 environment remediation cannot pass on configuration inspection alone. After a Codespaces rebuild, `make verify-dev-environment` must succeed and record actual Node, package-manager, Python, Docker/Compose, Bench, Vite and Frappe pin evidence. Until then Phase 3 remains paused.
