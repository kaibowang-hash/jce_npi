...
As of 2026-08-28, the repository contains network-free ERP integration
contracts and bounded P8-01 through P8-06 technical foundations. These are not
production ERPNext facts. The governed unknown/required-evidence baseline is
`docs/ERPNEXT_CUSTOMIZATION_REQUIREMENTS.md`; the sole request for external
facts remains `implementation/REQUIRED_INPUTS.md`. Production fact collection
is `QUEUED_NOT_EFFECTIVE` and
