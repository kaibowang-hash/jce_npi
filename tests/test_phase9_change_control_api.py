...
class Phase9ChangeControlApiTest(unittest.TestCase):
    ...
    def test_revise_server_diagnostic_is_dormant_without_runtime_environment(self) -> None:
        ...
        self.assertFalse(
            self.api.ENGINEERING_CHANGE_POST_MARKER_REPAIR_DIAGNOSTICS_ENABLED
        )
        self.assertFalse(
            self.api.ENGINEERING_CHANGE_POST_LOOPBACK_REPAIR_DIAGNOSTICS_ENABLED
        )
        self.assertFalse(
        ...
        self.assertFalse(
            self.api.ENGINEERING_CHANGE_POST_DATETIME_REPAIR_DIAGNOSTICS_ENABLED
        )
        self.assertFalse(
