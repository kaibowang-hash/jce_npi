...
class CurrentTaskVerifierTest(unittest.TestCase):
    ...
    def test_repository_manifest_and_state_pass(self) -> None:
        ...
        self.assertEqual(
            value["status"],
            "IN_PROGRESS_FINAL_GATE_PREDECESSOR_ITEM_LEGACY_DIAGNOSTICS_OFF_AWAITS_EXACT_SHA_ORDINARY",
        )
        ...
        for invariant in (
            ...
            "P8_09_ITEM_LEGACY_DIAGNOSTIC_MANIFEST_EXPANSION_527B9B20_ORDINARY_33340474669_ALL_FOUR_JOBS_PASS",
            "P8_09_ITEM_LEGACY_DIAGNOSTIC_NEW_ONLY_ONE_OF_NINE_ACTIVE_EXACT_SIXTY_SEVEN_PRODUCT_ZERO",
            "P8_09_ITEM_LEGACY_DIAGNOSTIC_LEVEL_1_ITEM_SUITE_151_OF_151_PASS",
            "P8_09_ITEM_LEGACY_CONTROLLED_33341711275_PREFLIGHT_99338413373_RUNTIME_99338441701_SUCCESS_ZERO_NO_PRODUCT_REPAIR",
            "P8_09_ITEM_LEGACY_ALL_NINE_DIAGNOSTIC_FLAGS_FALSE_BEFORE_FINAL_GATE",
