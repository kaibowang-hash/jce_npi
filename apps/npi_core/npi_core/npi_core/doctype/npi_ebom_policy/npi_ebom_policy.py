...
class NPIEBOMPolicy(Document):
    """Project-scoped administrative root for synthetic EBOM policies."""
    ...
    def before_validate(self) -> None:
        ...
        self.policy_key = key_text(self.policy_key, _("EBOM Policy Key"))
        ...
        self.title = required_text(self.title, _("EBOM Policy Title"), 140)
        if self.is_new():
    ...
    def validate(self) -> None:
        require_exact_parent(
            ...
            _("The EBOM policy does not match its Project and tenant."),
        )
