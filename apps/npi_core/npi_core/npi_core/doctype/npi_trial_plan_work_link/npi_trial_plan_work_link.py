...
from npi_core.trial.metadata_validation import (
    ...
    normalize_work_link_identity,
    validate_work_link_document,
)


class NPITrialPlanWorkLink(Document):
    """Immutable link to the governed Domain Work Item task truth."""
    ...
    def before_validate(self) -> None:
        normalize_work_link_identity(self)

    def validate(self) -> None:
        if self.get_doc_before_save() is not None:
            deny_trial_history_update()
        validate_work_link_document(self)
