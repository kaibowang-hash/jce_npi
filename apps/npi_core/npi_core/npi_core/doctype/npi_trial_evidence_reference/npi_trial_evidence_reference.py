...
from npi_core.trial.metadata_validation import (
    ...
    normalize_evidence_identity,
    validate_evidence_document,
)


class NPITrialEvidenceReference(Document):
    """Immutable exact clean private Trial evidence reference."""
    ...
    def before_validate(self) -> None:
        normalize_evidence_identity(self)
