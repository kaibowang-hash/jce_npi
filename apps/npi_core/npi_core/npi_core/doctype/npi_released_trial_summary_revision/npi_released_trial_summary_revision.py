...
from npi_core.trial.released_summary_metadata_validation import (
    normalize_released_summary_identity,
    validate_released_summary_document,
)


class NPIReleasedTrialSummaryRevision(Document):
    """Append-only exact-source technical Trial summary revision."""
    ...
    def before_validate(self) -> None:
        normalize_released_summary_identity(self)
