...
from npi_core.gate_template.domain import validate_gate_template_code
...
class NPIGateTemplate(Document):
    """Administrative root for explicitly versioned Gate Templates."""
    ...
    def validate(self) -> None:
        ...
        try:
            self.template_code = validate_gate_template_code(self.template_code)
