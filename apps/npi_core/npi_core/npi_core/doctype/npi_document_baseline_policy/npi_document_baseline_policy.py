...
class NPIDocumentBaselinePolicy(Document):
    """Project-scoped administrative root for exact baseline policies."""
    ...
    def before_validate(self) -> None:
        ...
        self.policy_key = key_text(self.policy_key, _("Baseline Policy Key"))
        ...
        self.title = required_text(self.title, _("Baseline Policy Title"), 140)
        if self.is_new():
    ...
    def validate(self) -> None:
        require_exact_parent(
            ...
            _("The baseline policy does not match its Project and tenant."),
        )
