...
class PublishRequestRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "EBOM_PUBLISH_REQUEST_ROUTES_DISABLED",
            _("The EBOM workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )
...
class ToolingRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TOOLING_ROUTES_DISABLED",
...
class ToolingSetRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TOOLING_SET_ROUTES_DISABLED",
            _("The Tooling workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )
...
class ToolingRevisionRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TOOLING_REVISION_ROUTES_DISABLED",
            _("The Tooling Revision workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )


class ToolingManufacturingRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
...
class ToolingEngineeringControlsRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
...
class ToolingImportRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TOOLING_IMPORT_ROUTES_DISABLED",
            _("The Tooling import workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )


class ToolingExportRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TOOLING_EXPORT_ROUTES_DISABLED",
            _("The Tooling List export workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )


class TrialRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "TRIAL_ROUTES_DISABLED",
            _("The Trial planning workspace is temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )


class ReportingRoutesDisabled(NpiProblem):
    def __init__(self) -> None:
        super().__init__(
            503,
            "REPORTING_ROUTES_DISABLED",
            _("Portfolio and reporting are temporarily unavailable."),
            _("The routes are disabled while a reviewed forward fix is applied."),
            retryable=True,
        )
