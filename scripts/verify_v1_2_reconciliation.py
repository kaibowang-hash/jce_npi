...
EXPECTED_P8_09_COMPLETED_EVIDENCE = {
...
EXPECTED_P8_09_COMPLETED_STATUS = (
...
EXPECTED_P8_CARRIED_FOUNDATIONS = {
    ...
    "FR-BR-002": ("8", EXPECTED_P8_09_COMPLETED_STATUS),
    "UX-016": ("8", "TECHNICAL_VERIFIED_FOUNDATION"),
}
...
def verify_p8_07f_fact_documents() -> None:
    ...
    inventory_tokens = {
        ...
        "REJECTED_BEFORE_SSH",
        "APP_STATUS",
        "acbd6882869a4a8c27eb653019080354055f74a8",
        "33297909199",
        "ACCEPTED_SANITIZED",
        "PARTIAL_ACCEPTED_WITH_TWO_SENSITIVE_PREFLIGHT_STOPS",
        "sha256:fe62534f3d045932fca83ca09faa06c8b00015e8a9ec8262a1a0b36253496991",
        "sha256:717183d4ea65f8c171d2d3cb8b27c4b8fc57efb9720ae63671be9ef6211fd14d",
        "mode-0600 private",
        "state was then deleted",
...
def verify_trace_sets() -> None:
    ...
    if (
        p8_09_row["phase"],
        p8_09_row["status"],
    ) != ("8", EXPECTED_P8_09_COMPLETED_STATUS):
        raise ReconciliationVerificationError(
            "FR-BR-002 does not retain the P8-09 presentation-only truth"
        )
    if not EXPECTED_P8_09_COMPLETED_EVIDENCE.issubset(p8_09_evidence):
        raise ReconciliationVerificationError(
            "FR-BR-002 lacks the P8-09 completion evidence"
        )
