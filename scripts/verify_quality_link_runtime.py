...
def _combined_boundary_diagnostics_enabled() -> bool:
    return (
        ...
        or QUALITY_LINK_POST_REPLAY_COMBINED_BOUNDARY_DIAGNOSTICS_ENABLED
        or QUALITY_LINK_POST_REPLAY_FINAL_COMBINED_BOUNDARY_DIAGNOSTICS_ENABLED
        or QUALITY_LINK_POST_REPLAY_FINAL_FAILURE_COMBINED_BOUNDARY_DIAGNOSTICS_ENABLED
    )
